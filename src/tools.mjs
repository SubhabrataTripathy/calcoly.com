...
export const tools = [
     ...
     ============================================================ */
  {
    ...
    metaTitle: 'Kg to Lbs Converter — Kilograms to Pounds | Calcoly',
    metaDesc: 'Convert kilograms to pounds instantly. Live results as you type, exact formula, quick conversion table. Free, no sign-up.',
    kw: ['kg to lbs', 'kilograms to pounds', 'kg lb', 'kilos to pounds', '50 kg to lbs', '80 kg in lbs'],
    widget: { type: 'convert', factor: 2.2046226218, from: { unit: 'kg', label: 'Kilograms' }, to: { unit: 'lbs', label: 'Pounds' }, start: 1, dec: 4 },
    lead: 'Type a weight in kilograms and see pounds instantly — live calculations update as you type in both directions.',
    formula: 'pounds = kilograms × 2.20462',
    examples: [
      'A typical adult male weighing 80 kg equals 176.37 lbs.',
      'A standard check-in airline bag limit of 23 kg is about 50.71 lbs.',
      'An average newborn weighing 3.5 kg equals 7.72 lbs.'
    ],
    invertedSlug: 'lbs-to-kg',
    related: ['lbs-to-kg', 'grams-to-ounces', 'stone-to-kg', 'kg-to-stone', 'grams-to-kg'],
    faqs: [
      { q: 'How many pounds is 1 kilogram?', a: 'One kilogram equals 2.20462 pounds (exactly 2.2046226218 lb per kg).' },
      { q: 'How do I convert kg to lbs in my head?', a: 'Double the kilograms, then add a tenth of that. For 80 kg: 80 × 2 = 160, plus 16 = 176 lbs (close to exact 176.37).' },
      { q: 'What is 50 kg in lbs?', a: '50 kg equals 110.23 pounds.' },
      { q: 'Why do the US and UK still use pounds?', a: 'Both countries retain everyday use of pounds and stones while officially using metric units, making this conversion very popular.' },
    ],
  },
  {
    slug: 'lbs-to-kg', pillar: 'converters', prefix: 'converter', ecosystem: 'Weight', name: 'lbs → kg',
    h1: 'Lbs to Kg Converter',
    metaTitle: 'Lbs to Kg Converter — Pounds to Kilograms | Calcoly',
    metaDesc: 'Convert pounds to kilograms instantly. Live results as you type, exact formula, quick conversion table. Free, no sign-up.',
    kw: ['lbs to kg', 'pounds to kilograms', 'lb kg', 'pounds to kilos', '150 lbs to kg', '200 lbs in kg'],
    widget: { type: 'convert', factor: 0.45359237, from: { unit: 'lbs', label: 'Pounds' }, to: { unit: 'kg', label: 'Kilograms' }, start: 1, dec: 4 },
    lead: 'Enter a weight in pounds and get kilograms instantly — calculations work live in both directions as you type.',
    formula: 'kilograms = pounds × 0.45359',
    examples: [
      'A gym weight of 200 lbs equals 90.72 kg.',
      'An average adult weighing 150 lbs equals 68.04 kg.',
      'A 10 lb weight bag equals 4.54 kg.'
    ],
    invertedSlug: 'kg-to-lbs',
    related: ['kg-to-lbs', 'stone-to-kg', 'ounces-to-grams', 'ounces-to-lbs'],
    faqs: [
      { q: 'How many kilograms is 1 pound?', a: 'One pound equals 0.45359 kilograms (defined internationally as exactly 0.45359237 kg).' },
      { q: 'What is 200 lbs in kg?', a: '200 pounds equals 90.72 kilograms.' },
      { q: 'How do I convert lbs to kg in my head?', a: 'Divide by 2.2. For 150 lbs: 150 ÷ 2.2 ≈ 68.2 kg (exact: 68.04 kg).' },
    ],
  },
  {
     ...
     ============================================================ */
  {
    ...
    metaTitle: 'CM to Inches Converter — Centimeters to Inches | Calcoly',
    metaDesc: 'Convert centimeters to inches instantly. Live results as you type, exact formula, quick conversion table. Free.',
    kw: ['cm to inches', 'centimeters to inches', 'cm inch', '30 cm to inches'],
    widget: { type: 'convert', factor: 0.3937007874, from: { unit: 'cm', label: 'Centimeters' }, to: { unit: 'in', label: 'Inches' }, start: 10, dec: 4 },
    lead: 'Convert centimeters to inches instantly — live, two-way, with the exact 2.54 cm per inch definition.',
    formula: 'inches = centimeters ÷ 2.54',
    examples: [
      'A standard 30 cm ruler equals 11.81 inches.',
      '100 cm (1 meter) equals 39.37 inches.',
      '15 cm equals 5.91 inches.'
    ],
    invertedSlug: 'inches-to-cm',
    related: ['inches-to-cm', 'mm-to-inches', 'cm-to-feet', 'meters-to-feet'],
    faqs: [
      { q: 'How many inches is 1 cm?', a: 'One centimeter equals 0.3937 inches (1 inch is defined as exactly 2.54 cm).' },
      { q: 'What is 30 cm in inches?', a: '30 cm equals 11.81 inches.' },
      { q: 'How do I convert cm to inches in my head?', a: 'Divide by 2.5. For 100 cm: 100 ÷ 2.5 = 40 inches (close to exact 39.37).' },
    ],
  },
  {
    slug: 'inches-to-cm', pillar: 'converters', prefix: 'converter', ecosystem: 'Length', name: 'inches → cm',
    h1: 'Inches to CM Converter',
    metaTitle: 'Inches to CM Converter — Inches to Centimeters | Calcoly',
    metaDesc: 'Convert inches to centimeters instantly. Live results as you type, exact formula, quick conversion table. Free.',
    kw: ['inches to cm', 'inches to centimeters', 'inch cm', '65 inch in cm'],
    widget: { type: 'convert', factor: 2.54, from: { unit: 'in', label: 'Inches' }, to: { unit: 'cm', label: 'Centimeters' }, start: 1, dec: 3 },
    lead: 'Enter inches, get centimeters instantly — based on the exact definition 1 inch = 2.54 cm.',
    formula: 'centimeters = inches × 2.54',
    examples: [
      'A 55-inch TV screen diagonal equals 139.7 cm.',
      'A 65-inch TV screen diagonal equals 165.1 cm.',
      '12 inches (1 foot) equals 30.48 cm.'
    ],
    invertedSlug: 'cm-to-inches',
    related: ['cm-to-inches', 'inches-to-mm', 'inches-to-feet'],
    faqs: [
      { q: 'How many cm is 1 inch?', a: 'Exactly 2.54 centimeters.' },
      { q: 'What is 55 inches in cm?', a: '55 inches equals 139.7 cm.' },
    ],
  },
  {
    slug: 'mm-to-inches', pillar: 'converters', prefix: 'converter', ecosystem: 'Length', name: 'mm → inches',
    h1: 'MM to Inches Converter',
    metaTitle: 'MM to Inches Converter — Millimeters to Inches | Calcoly',
    metaDesc: 'Convert millimeters to inches instantly. Live results as you type, exact formula, engineering conversion table. Free.',
    kw: ['mm to inches', 'millimeters to inches', 'mm in inch', '10mm to inches'],
    widget: { type: 'convert', factor: 0.03937007874, from: { unit: 'mm', label: 'Millimeters' }, to: { unit: 'in', label: 'Inches' }, start: 10, dec: 4 },
    lead: 'Convert millimeters to inches for engineering, machining, and DIY — precise live calculation.',
    formula: 'inches = millimeters ÷ 25.4',
    examples: [
      '10 mm (1 cm) equals 0.3937 inches.',
      '25.4 mm equals exactly 1 inch.',
      '5 mm equals 0.1969 inches.'
    ],
    invertedSlug: 'inches-to-mm',
    related: ['inches-to-mm', 'cm-to-inches', 'cm-to-feet'],
    faqs: [
      { q: 'How many inches is 10 mm?', a: '10 mm equals 0.3937 inches.' },
      { q: 'How many mm in an inch?', a: 'There are exactly 25.4 mm in 1 inch.' },
    ],
  },
  {
     ...
     ============================================================ */
  {
    ...
    metaTitle: 'Celsius to Fahrenheit (°C to °F) Converter | Calcoly',
    metaDesc: 'Convert Celsius to Fahrenheit instantly. Live results as you type, exact formula, and key temperatures table. Free.',
    kw: ['celsius to fahrenheit', 'c to f', 'centigrade to fahrenheit', '20 c in f'],
    widget: { type: 'convert', mode: 'c2f', from: { unit: '°C', label: 'Celsius' }, to: { unit: '°F', label: 'Fahrenheit' }, start: 20, dec: 2 },
    lead: 'Convert Celsius to Fahrenheit instantly — weather, oven settings, and science temperatures live.',
    formula: '°F = °C × 9/5 + 32',
    examples: [
      '20°C (room temperature) equals 68°F.',
      '100°C (boiling water) equals 212°F.',
      '37°C (normal body temp) equals 98.6°F.'
    ],
    invertedSlug: 'fahrenheit-to-celsius',
    related: ['fahrenheit-to-celsius', 'miles-to-km', 'kg-to-lbs'],
    faqs: [
      { q: 'What is 20°C in Fahrenheit?', a: '20°C equals 68°F.' },
      { q: 'What is the formula for °C to °F?', a: 'Multiply Celsius by 1.8 (or 9/5) and add 32.' },
      { q: 'At what temperature are °C and °F equal?', a: 'At −40° both scales are identical (−40°C = −40°F).' },
    ],
  },
  {
    ...
    metaTitle: 'Fahrenheit to Celsius (°F to °C) Converter | Calcoly',
    metaDesc: 'Convert Fahrenheit to Celsius instantly. Live results as you type, exact formula, and oven temperature chart. Free.',
    kw: ['fahrenheit to celsius', 'f to c', '350 f in c', '98.6 f in c'],
    widget: { type: 'convert', mode: 'f2c', from: { unit: '°F', label: 'Fahrenheit' }, to: { unit: '°C', label: 'Celsius' }, start: 68, dec: 2 },
    lead: 'Enter Fahrenheit, get Celsius instantly — oven temperatures, fever checks, and weather live.',
    formula: '°C = (°F − 32) × 5/9',
    examples: [
      '350°F (standard baking oven) equals 176.67°C (approx 180°C fan).',
      '98.6°F (normal body temp) equals 37°C.',
      '72°F (comfortable room) equals 22.22°C.'
    ],
    invertedSlug: 'celsius-to-fahrenheit',
    related: ['celsius-to-fahrenheit', 'cups-to-grams', 'miles-to-km'],
    faqs: [
      { q: 'What is 350°F in Celsius?', a: '350°F equals 176.67°C (often rounded to 175°C or 180°C in recipes).' },
      { q: 'How do I convert °F to °C in my head?', a: 'Subtract 30, then halve it. For 72°F: (72 − 30)/2 = 21°C (exact: 22.22°C).' },
    ],
  },
     ...
     ============================================================ */
  {
    ...
    metaTitle: 'Percentage Calculator — Calculate Percentages Instantly | Calcoly',
    metaDesc: 'Three percentage tools in one: what is X% of Y, X is what percent of Y, and percent change. Free, instant.',
    kw: ['percentage calculator', 'percent calculator', 'what is x percent of', 'percent change'],
    widget: { type: 'percentage' },
    lead: 'Three percentage questions, three instant answers — all calculated live as you type.',
    formula: 'percentage = (part / total) × 100',
    examples: [
      'What is 15% of $200? Result: $30.',
      '30 is what percent of 200? Result: 15%.',
      'A increase from 80 to 100 equals +25% change.'
    ],
    related: ['percentage-increase', 'percentage-decrease', 'percent-off', 'discount', 'tip'],
    faqs: [
      { q: 'How do I calculate a percentage of a number?', a: 'Multiply the number by the percentage as a decimal: 15% of 200 = 200 × 0.15 = 30.' },
      { q: 'How do I calculate percentage change?', a: 'Subtract old value from new, divide by old value, and multiply by 100.' },
    ],
  },
  {
    ...
    metaTitle: 'Percentage Increase Calculator — Calculate % Growth | Calcoly',
    metaDesc: 'Calculate the percentage increase between two numbers or add a percent to a value instantly. Free.',
    kw: ['percentage increase calculator', 'percent increase', 'how to calculate percentage increase'],
    widget: { type: 'pct_inc' },
    lead: 'Calculate the percentage increase between an initial value and final value instantly.',
    formula: 'increase % = ((new - old) / old) × 100',
    examples: [
      'Salary rising from $50,000 to $55,000 is a 10% increase.',
      'Price going from $80 to $100 is a 25% increase.'
    ],
    related: ['percentage-decrease', 'percentage', 'percent-off'],
    faqs: [
      { q: 'How do I calculate a 10% increase?', a: 'Multiply the original number by 1.10.' },
      { q: 'What is the formula for percent increase?', a: '((New Value − Old Value) ÷ Old Value) × 100.' },
    ],
  },
  {
     ...
     ============================================================ */
  {
    ...
    metaTitle: 'Cups to Grams Converter — With Ingredient Chart | Calcoly',
    metaDesc: 'Convert cups to grams for flour, sugar, butter and 16 ingredients. Live results with per-ingredient densities. Free.',
    kw: ['cups to grams', 'cup to gram', 'baking conversion', 'how many grams in a cup of flour'],
    widget: { type: 'cupsgrams', dir: 'c2g' },
    lead: 'A cup of flour and a cup of sugar weigh very different amounts — select your ingredient for an exact grams result.',
    ...
    related: ['grams-to-cups', 'recipe-scaler', 'tbsp-to-cups', 'sourdough-hydration'],
    faqs: [
      { q: 'How many grams is a cup of flour?', a: 'A US cup of all-purpose flour equals 120 g, while granulated sugar is 200 g.' },
      { q: 'Why do bakers weigh ingredients in grams?', a: 'Weight is exact, whereas volume in cups varies depending on how firmly flour is packed.' },
    ],
  },
  {
